...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            enqueueUserTask(from, async () => {
                ...
                // קלט טקסט חופשי — כל שלב עם פלייסהולדר בעמודה 3, כשהוא לא ב־AWAITING_TEXT
                if (
                    stageRow &&
                    stageRow.length >= 3 &&
                ...
                if (String(currentStage).endsWith('_AWAITING_TEXT')) {
                    ...
                    if (nextStage) {
                        ...
                        // לאחר עדכון הסטייט - שליחה מיידית של השלב החדש
